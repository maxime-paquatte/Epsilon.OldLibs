...
namespace Epsilon.Utils
{
    ...
    {        //Généré depuis les valeurs de IIS
        public static System.Net.Mime.ContentType GetContentType(string ext)
        {
            return new System.Net.Mime.ContentType(GetMimeType(ext));
        }
        ...
        {
            if (ext[0] != '.') ext = Path.GetExtension(ext);
